...
class FramesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frame" do
    assert_difference('Frame.count') do
      post frames_url, params: { frame: { frame_score: @frame.frame_score, game_id: @frame.game_id, name: @frame.name } }
    end
  ...
  test "should update frame" do
    patch frame_url(@frame), params: { frame: { frame_score: @frame.frame_score, game_id: @frame.game_id, name: @frame.name } }
